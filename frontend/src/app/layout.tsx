...
export const metadata: Metadata = {
  title: "MSBS-Next Simulator",
  description: "MSBS-Next Simulator: Mobile Suit Battle Simulator",
};
  ...
  return (
    <ClerkProvider>
      <html lang="ja">
        ...
        >
          <Header />
          <main className="flex-1 overflow-y-auto pb-16 md:pb-0 md:overflow-visible">
            {children}
          </main>
          <BottomNav />
        </body>
