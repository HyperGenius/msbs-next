...
├── docs/                      # プロジェクトドキュメント
│   ├── roadmap/
│   │   └── overall-roadmap.md # 開発ロードマップ (メインドキュメント)
│   └── ...                    # 各種実装ガイド & レポート
│
└── infra/                     # Terraform HCL
    └── neon/                  # Neon DB作成
...
* **`docs/roadmap/overall-roadmap.md`** - プロジェクトの全体像、実装済み機能、今後の計画
* **`docs/roadmap/battle-simulation.md`** - シミュレーションエンジンの詳細仕様
* **`docs/architecture/batch-system.md`** - バッチ処理システムの仕様
* **`docs/architecture/pilot-system.md`** - パイロット成長・スキルシステム
* **実装レポート** (`docs/implementations/`) - 各機能の実装詳細
