...
def upgrade() -> None:
    ...
    op.add_column('mobile_suits', sa.Column('is_ace', sa.Boolean(), nullable=False, server_default='false'))
    ...
    op.add_column('mobile_suits', sa.Column('bounty_exp', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('mobile_suits', sa.Column('bounty_credits', sa.Integer(), nullable=False, server_default='0'))
