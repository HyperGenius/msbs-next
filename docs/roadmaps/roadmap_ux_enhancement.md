...
**⏳ 1.1-1.2 Onboarding** - 未着手  
**⏳ 2.1-2.2 Weapon Customization** - 未着手  
**⏳ 5.1 Mobile Optimization** - 未着手
...
| **Step 1** | 1週間 | **オンボーディング完了**: 初期機体配布とチュートリアル表示の実装。 | ⏳ 未着手 |
| **Step 2** | 2週間 | **カスタマイズ深化**: 武器データの独立化、ショップでの武器販売、ガレージでの装備変更。 | ⏳ 未着手 |
| **Step 3** | 2週間 | **モバイル最適化**: モバイルUIの磨き込み。 | ⏳ 未着手 |
